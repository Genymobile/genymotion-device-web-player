...
module.exports = class GamepadManager {
    ...
    removeGamepadCallbacks() {
        this.instance.removeListener(window,'gamepadconnected', this.onGamepadConnected.bind(this));
        this.instance.removeListener(window,'gamepaddisconnected', this.onGamepadConnected.bind(this));
    }
