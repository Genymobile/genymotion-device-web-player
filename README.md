...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@genymotion/device-web-player@3.0.3/dist/css/device-renderer.min.css">
<script src="https://cdn.jsdelivr.net/npm/@genymotion/device-web-player@3.0.3/dist/js/device-renderer.min.js"></script>
```
