...
export default class IOThrottling extends OverlayPlugin {
    ...
    renderWidget() {
        ...
        this.dropdownProfile.setAttribute('has-checkmark', '');
        this.dropdownProfile.setAttribute('max-height', '205');

        this.dropdownProfile.addEventListener('gm-change', (e) => {
        ...
        this.readByteRate.regexFilter = /^[0-9]*$/;

        this.readByteRate.addEventListener('gm-input', (e) => {
