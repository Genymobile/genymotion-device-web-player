...
export default class BasebandRIL extends OverlayPlugin {
    ...
    renderWidget() {
        ...
        this.networkOperatorMMC.className = 'gm-network-mmc';
        this.networkOperatorMMC.setAttribute('placeholder', 'eg: 20814');
        this.networkOperatorMMC.setAttribute('message-field', 'true');
        this.networkOperatorMMC.regexFilter = /^[0-9]{0,6}$/;
        this.networkOperatorMMC.regexValidField = /^[0-9]{5,6}$/;

        this.networkOperatorMMC.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
        ...
        this.networkOperatorName.className = 'gm-network-name';
        this.networkOperatorName.setAttribute('placeholder', 'eg: Verizon');
        this.networkOperatorName.setAttribute('message-field', 'true');

        this.networkOperatorName.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
            this.container.classList.remove('gm-baseband-saved');
        });
        ...
        this.simOperatorMMC.className = 'gm-sim-mmc';
        this.simOperatorMMC.setAttribute('placeholder', 'eg: 20814');
        this.simOperatorMMC.setAttribute('message-field', 'true');
        this.simOperatorMMC.regexFilter = /^[0-9]{0,6}$/;
        this.simOperatorMMC.regexValidField = /^[0-9]{5,6}$/;

        this.simOperatorMMC.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
            this.container.classList.remove('gm-baseband-saved');
        });
        ...
        this.simOperatorName.className = 'gm-sim-name';
        this.simOperatorName.setAttribute('placeholder', 'eg: AT&T');
        this.simOperatorName.setAttribute('message-field', 'true');

        this.simOperatorName.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
            this.container.classList.remove('gm-baseband-saved');
        });
        ...
        this.simMSIN.className = 'gm-sim-msin';
        this.simMSIN.setAttribute('placeholder', 'eg: 2176510739');
        this.simMSIN.setAttribute('message-field', 'true');
        this.simMSIN.regexFilter = /^[0-9]{0,10}$/;
        this.simMSIN.regexValidField = /^[0-9]{9,10}$/;

        this.simMSIN.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
        ...
        this.simOperatorPhoneNumber.className = 'gm-sim-phone';
        this.simOperatorPhoneNumber.setAttribute('placeholder', 'eg: 8004337300');
        this.simOperatorPhoneNumber.setAttribute('message-field', 'true');
        this.simOperatorPhoneNumber.regexFilter = /^[0-9+\-().\s]{0,25}$/;
        this.simOperatorPhoneNumber.regexValidField = /^[0-9+\-().\s]+$/;

        this.simOperatorPhoneNumber.addEventListener('gm-input', () => {
            this.checkIfFormIsValid();
            this.container.classList.remove('gm-baseband-saved');
        });
